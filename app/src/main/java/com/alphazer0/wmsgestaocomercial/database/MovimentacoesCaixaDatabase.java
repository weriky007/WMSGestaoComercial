...
public abstract class MovimentacoesCaixaDatabase extends RoomDatabase {
    ...
    private static final String NOME_BD = "movimentacoes_caixa.db";
    public abstract RoomMovimentacaoCaixaDAO getMovimentacaoCaixaDAO();

    public static MovimentacoesCaixaDatabase getInstance(Context context){
        return Room.databaseBuilder(context, MovimentacoesCaixaDatabase.class, NOME_BD)
