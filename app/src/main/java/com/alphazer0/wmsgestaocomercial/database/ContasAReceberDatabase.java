...
@Database(entities = {ContaAReceber.class},version = 2, exportSchema = false)

//ADICIONANDO OS TIPOS DE CONVERSOR QUE VAMOS TER NO PROJETO
@TypeConverters({ConversorCalendar.class})
public abstract class ContasAReceberDatabase extends RoomDatabase {
    ...
    private static final String NOME_BD = "contasAReceber.db";
    public abstract RoomContaAReceberDAO getContasAReceberDAO();

    public static ContasAReceberDatabase getInstance(Context context){
        return Room.databaseBuilder(context, ContasAReceberDatabase.class, NOME_BD)
