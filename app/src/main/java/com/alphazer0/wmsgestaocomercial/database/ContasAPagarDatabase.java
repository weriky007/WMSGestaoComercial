...
@Database(entities = {ContaAPagar.class},version = 2, exportSchema = false)

//ADICIONANDO OS TIPOS DE CONVERSOR QUE VAMOS TER NO PROJETO
@TypeConverters({ConversorCalendar.class})
public abstract class ContasAPagarDatabase extends RoomDatabase {
    ...
    private static final String NOME_BD = "contasAPagar.db";
    public abstract RoomContaAPagarDAO getContasAPagarDAO();

    public static ContasAPagarDatabase getInstance(Context context){
        return Room.databaseBuilder(context, ContasAPagarDatabase.class, NOME_BD)
